...
test_that("reporte_ppt_plan acepta referencias fuente$var en graficos simples", {
  ...
  plan <- list(
    diapo_001 = p_slide_1(
      plot = p_barras_apiladas("estudiantes$p1")
    )
  )
...
test_that("reporte_ppt_plan permite dos graficos de fuentes distintas en una slide", {
  ...
  plan <- list(
    diapo_001 = p_slide_2(
      left = p_barras_apiladas("estudiantes$p1"),
      right = p_barras_apiladas("docentes$p1")
    )
  )
...
test_that("var_cruce multi-fuente convive con title y section en el log del plan", {
  ...
  plan <- list(
    diapo_001 = p_slide_title(
      title = "Titulo",
      subtitle = "Subtitulo",
      date = "Marzo 2026"
    ),
    diapo_002 = p_slide_section(
      title = "Seccion"
    ),
    diapo_003 = p_slide_1(
      plot = p_barras_multiapiladas(
